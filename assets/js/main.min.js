...
const translate_switch=document.querySelector(".switch-button-checkbox"),translate_header=document.querySelector();function changeData(e){fetch("../../language/"+e).then(e=>e.json()).then(e=>{console.log(e)})}translate_switch.addEventListener("change",async function(){changeData(this.checked?"en.json":"pt.json")});